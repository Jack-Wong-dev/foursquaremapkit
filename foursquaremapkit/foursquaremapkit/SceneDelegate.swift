...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let favoriteVC = CollectionsViewController()
       
        mainVC.tabBarItem = UITabBarItem(tabBarSystemItem: .search, tag: 0)
        favoriteVC.tabBarItem = UITabBarItem(title: "Collection", image: UIImage(systemName: "folder.fill.badge.plus"), tag: 1)
        ...
        tabBarController.viewControllers = [mainVCNav, favoriteVCNav]
